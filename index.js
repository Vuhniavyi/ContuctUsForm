        ...
        [].slice.call(this.el.children).forEach(function (s) {
          if (!s.disabled) {
            ...
            "option" === l
              ...
              : "optgroup" === l &&
                ((e +=
                  '<li class="cs-optgroup"><span>' + s.label + "</span><ul>"),
...
$(".input").on("focus blur", function () {
  ...
  if (
    ...
    $(this).parent().addClass("errorTextTrue");
    $(this).siblings().addClass("errorTextTrue");
    $(this).parent().addClass("error");
    $(this).siblings().addClass("error");
  } else {
    $(this).parent().removeClass("invalid");
    $(this).siblings().removeClass("invalid");
    $(this).parent().removeClass("errorTextTrue");
    $(this).siblings().removeClass("errorTextTrue");
